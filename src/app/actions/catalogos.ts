  ...
  try {
    const resultados = await db
      .select({
        ...
        nombre_gafete: solicitudes_inscripcion.nombre_gafete,
        correo: solicitudes_inscripcion.correo,
        telefono_celular: solicitudes_inscripcion.telefono_celular,
        telefono_alternativo: solicitudes_inscripcion.telefono_alternativo,
        fecha_nacimiento: solicitudes_inscripcion.fecha_nacimiento,
        edad: solicitudes_inscripcion.edad,
        sexo: solicitudes_inscripcion.sexo,
        estado_civil: solicitudes_inscripcion.estado_civil,
        direccion_completa: solicitudes_inscripcion.direccion_completa,
        pais_ciudad: solicitudes_inscripcion.pais_ciudad,
        contacto_emergencia_nombre: solicitudes_inscripcion.contacto_emergencia_nombre,
        contacto_emergencia_telefono: solicitudes_inscripcion.contacto_emergencia_telefono,
        parentezco_emergencia: solicitudes_inscripcion.parentezco_emergencia,
        parroquia_procedencia: solicitudes_inscripcion.parroquia_procedencia,
        ultimo_sacramento: solicitudes_inscripcion.ultimo_sacramento,
        expectativas: solicitudes_inscripcion.expectativas,
        dificultad_escaleras: solicitudes_inscripcion.dificultad_escaleras,
        enfermedades_alergias: solicitudes_inscripcion.enfermedades_alergias,
        comparte_cuarto_con: solicitudes_inscripcion.comparte_cuarto_con,
        esposo_a_nombre: solicitudes_inscripcion.esposo_a_nombre,
        fecha_boda: solicitudes_inscripcion.fecha_boda,
        cantidad_hijos: solicitudes_inscripcion.cantidad_hijos,
        nombre_edades_hijos: solicitudes_inscripcion.nombre_edades_hijos,
