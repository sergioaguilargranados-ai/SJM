...
export function AppFooter() {
  ...
  const buildTime = process.env.NEXT_PUBLIC_BUILD_TIME || "22-07-2026 18:05 (CDMX)";
  const appVersion = process.env.NEXT_PUBLIC_APP_VERSION ? `${process.env.NEXT_PUBLIC_APP_VERSION} - SJM Core Engine` : "v1.202 - SJM Core Engine";
