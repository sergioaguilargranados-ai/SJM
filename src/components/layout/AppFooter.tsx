...
export function AppFooter() {
  ...
  const buildTime = process.env.NEXT_PUBLIC_BUILD_TIME || "05-08-2026 21:24 (CDMX)";
  const appVersion = process.env.NEXT_PUBLIC_APP_VERSION ? `${process.env.NEXT_PUBLIC_APP_VERSION} - SJM Core Engine` : "v1.203 - SJM Core Engine";
