...
export function AppFooter() {
  ...
  const buildTime = process.env.NEXT_PUBLIC_BUILD_TIME || "22-08-2026 13:19 (CDMX)";
  const appVersion = process.env.NEXT_PUBLIC_APP_VERSION ? `${process.env.NEXT_PUBLIC_APP_VERSION} - SJM Core Engine` : "v1.218 - SJM Core Engine";
