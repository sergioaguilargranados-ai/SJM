...
export default function NuevoEventoForm({ sedes, casas, tipos, onSuccess, isModal, eventoToEdit }: { sedes: any[], casas: any[], tipos: any[], onSuccess?: () => void, isModal?: boolean, eventoToEdit?: any }) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      fecha_inicio: eventoToEdit?.fecha_inicio ? new Date(eventoToEdit.fecha_inicio).toISOString().slice(0, 16) : "",
      fecha_fin: eventoToEdit?.fecha_fin ? new Date(eventoToEdit.fecha_fin).toISOString().slice(0, 16) : "",
