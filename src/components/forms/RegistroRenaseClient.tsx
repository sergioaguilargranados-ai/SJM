...
const itinerarioSchema = z.object({
  fecha_hora_llegada: z.string().nullish(),
  lugar_llegada: z.string().nullish(),
  medio_transporte_llegada: z.string().nullish(),
  fecha_hora_salida: z.string().nullish(),
  lugar_salida: z.string().nullish(),
  medio_transporte_salida: z.string().nullish(),
  pase_abordar_url: z.string().nullish(),
  participa_salida_paseo: z.boolean().default(false),
  num_cuarto: z.string().nullish(),
  equipo: z.string().nullish(),
...
const servidorSchema = z.object({
  ...
  nombre_gafete: z.string().nullish(),
  correo: z.string().email("Inválido").nullish().or(z.literal("")),
  celular: z.string().min(10, "Obligatorio"),
  sede_id: z.string().nullish(),
  ministerio_id: z.string().nullish(),
  cargo_id: z.string().nullish(),
  estado_civil: z.string().nullish(),
  sexo: z.string().nullish(),
  fecha_nacimiento: z.string().nullish(),
  fecha_ingreso: z.string().nullish(),
  avance_servidor: z.string().nullish(),
  retiros_tomados: z.coerce.number().nullish(),
  observaciones: z.string().nullish(),
  fecha_baja: z.string().nullish(),
  domicilio_calle: z.string().nullish(),
  domicilio_colonia: z.string().nullish(),
  domicilio_cp: z.string().nullish(),
  contacto_emergencia: z.string().nullish(),
  tels_emergencia: z.string().nullish(),
  telefono_casa_trabajo: z.string().nullish(),
  facebook_url: z.string().nullish(),
  instagram_url: z.string().nullish(),
  tiktok_url: z.string().nullish(),
  youtube_url: z.string().nullish(),
  retiros_tomados_detalle: z.string().nullish(),
  retiros_externos_detalle: z.string().nullish(),
  servicios_sjm: z.string().nullish(),
  estatus: z.any().optional(),
